...
class CFM(nn.Module):
    def __init__(self, in_channel):
        ...
        self.rgb_ = BasicConv2d(in_channel, int(in_channel / 4), 1, padding=0, dilation=1)
        self.srgb_ = BasicConv2d(in_channel, int(in_channel / 4), 1, padding=0, dilation=1)
        

        self.rgb_sa = SA()
        self.rgb_ca = CA(int(in_channel / 4))

        self.srgb_sa = SA()
        self.srgb_ca = CA(int(in_channel / 4))
